...
**NOT YET WRITTEN.** This project has no specification. Nothing below this line is a requirement,
...
**Until it is written**, every gate that reads this file reports "not written yet" rather than
guessing, and no run has a definition of done.
